...
class ProductsTableSeeder extends Seeder
{
    ...
    {
        //
        $nameArray1 = ['Iron man 1', 'Piggy Peggy 1', 'Koala 1', 'kangaroo 1'];
        ...
        $i = 0;
        $nameArray2 = ['Iron man 2', 'Piggy Peggy 2', 'Koala 2', 'kangaroo 2'];
        ...
        $i = 0;
        $nameArray3 = ['Iron man 3', 'Piggy Peggy 3', 'Koala 3', 'kangaroo 3'];
